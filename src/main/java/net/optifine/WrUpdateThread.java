...
public class WrUpdateThread extends Thread
{
    ...
    public void run()
    {
        ...
        WrUpdateThread.ThreadUpdateListener updateListener = new WrUpdateThread.ThreadUpdateListener((WrUpdateThread.NamelessClass1508242905)null);
    ...
    static class NamelessClass1508242905
    {
    }
    ...
    private class ThreadUpdateControl implements IWrUpdateControl
    {
        ...
        ThreadUpdateControl(WrUpdateThread.NamelessClass1508242905 x1)
        {
            this();
        }
    }
    ...
    private class ThreadUpdateListener implements IWrUpdateListener
    {
        ...
        {
            this.tuc = WrUpdateThread.this.new ThreadUpdateControl((WrUpdateThread.NamelessClass1508242905)null);
        }
        ...
        ThreadUpdateListener(WrUpdateThread.NamelessClass1508242905 x1)
        {
            this();
        }
    }
