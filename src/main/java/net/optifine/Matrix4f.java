...
public final class Matrix4f
{
    ...
    {
        float f = pOther.getX();
        float f1 = pOther.getY();
        float f2 = pOther.getZ();
        float f3 = pOther.getW();
        float f4 = 2.0F * f * f;
        float f5 = 2.0F * f1 * f1;
        float f6 = 2.0F * f2 * f2;
        this.m00 = 1.0F - f5 - f6;
    ...
    {
        float f = pMultiplier.getX();
        float f1 = pMultiplier.getY();
        float f2 = pMultiplier.getZ();
        float f3 = pMultiplier.getW();
        float f4 = 2.0F * f * f;
        float f5 = 2.0F * f1 * f1;
        float f6 = 2.0F * f2 * f2;
        float f7 = f * f1;
    ...
    {
        this.m03 += pVector.getX();
        this.m13 += pVector.getY();
        this.m23 += pVector.getZ();
    }
