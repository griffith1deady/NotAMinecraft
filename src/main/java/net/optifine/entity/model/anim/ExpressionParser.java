...
public class ExpressionParser
{
    ...
    private IExpression parseExpression(Deque<Token> deque) throws ParseException
    {
        ...
        switch (ExpressionParser.NamelessClass702541709.$SwitchMap$net$optifine$entity$model$anim$TokenType[token.getType().ordinal()])
        {
            case 1:
    ...
    static class NamelessClass702541709
    {
