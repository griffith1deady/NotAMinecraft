...
import net.optifine.CustomColorizer;
import net.optifine.ItemRendererOF;
import net.optifine.RandomMobs;
import net.optifine.RenderPlayerOF;
import net.optifine.TextureUtils;
import net.optifine.WrUpdates;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void renderHand(float par1, int par2, boolean renderItem, boolean renderOverlay, boolean renderTranslucent)
    {
        if (this.debugViewDirection <= 0)
        {
            ...
            if (renderItem)
            {
                ...
                boolean shouldRenderHand1 = !ForgeHooksClient.renderFirstPersonHand(this.mc.renderGlobal, par1, par2);
        ...
        for (int var13 = 0; var13 < 2; ++var13)
        {
            ...
            if (this.debugViewDirection == 0)
            {
                ...
                if (this.mc.objectMouseOver != null && var4.isInsideOfMaterial(Material.water) && var4 instanceof EntityPlayer && !this.mc.gameSettings.hideGUI)
                {
                    ...
                    if (ForgeHooksClient.onDrawBlockHighlight(var5, var21, this.mc.objectMouseOver, 0, var21.inventory.getCurrentItem(), par1) && !this.mc.gameSettings.hideGUI)
                    {
    ...
    protected void renderRainSnow(float par1)
    {
        ...
        IRenderHandler renderHandler = var2.getWeatherRenderer();

        if (renderHandler != null)
        {
            renderHandler.render(par1, this.mc.theWorld, this.mc);
            return;
        }
    ...
    private void setupFog(int par1, float par2)
    {
        ...
        else
        {
            ...
            EntityViewRenderEvent.FogDensity fogDensity = new EntityViewRenderEvent.FogDensity(this, var3, var5, par2, 0.1F);

            if (MinecraftForge.EVENT_BUS.post(fogDensity))
            {
                float var10 = fogDensity.density;
