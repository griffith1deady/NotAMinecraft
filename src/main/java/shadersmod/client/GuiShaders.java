...
import net.optifine.TooltipProviderEnumShaderOptions;
...
public class GuiShaders extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton button)
    {
        if (button.enabled)
        {
            if (button instanceof GuiButtonEnumShaderOption)
            {
                ...
                switch (GuiShaders.NamelessClass1486218399.$SwitchMap$shadersmod$client$EnumShaderOption[var11.getEnumShaderOption().ordinal()])
                {
                    case 1:
    ...
    static class NamelessClass1486218399
    {
