...
{
    public static final int READ_TIMEOUT = Integer.getInteger(System.getProperty("fml.readTimeout","30"),30);
    public static final int LOGIN_TIMEOUT = Integer.getInteger(System.getProperty("fml.loginTimeout","600"),600);
